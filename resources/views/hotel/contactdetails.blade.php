                    ...
                    <form id="hotelForm" method="POST" action="{{ route('hotels.createcontacts') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Hotel Reservation Contact No</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Hotel Reservation Email</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Revenue Contact No</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Revenue Email</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Sales & Marketing Contact No</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Sales & Marketing Email</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Finance Contact No</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Finance Email</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Food & Beverage Contact No</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Director of Food & Beverage Email</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Marketing Director/Manager Contact No</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Marketing Director/Manager Email</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Account Manager Contact No</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>Account Manager Email</strong></label>
                            ...
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>General Manager Contact No</strong></label>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <label class="form-label"><strong>General Manager Email</strong></label>
