class App {
    initComponents() {
        lucide.createIcons(), Waves.init(), $(window).on("load", function() {
...
class ThemeCustomizer {
    ...
    setSwitchFromConfig() {
        sessionStorage.setItem("__ADMINOX_CONFIG__", JSON.stringify(this.config)), document.querySelectorAll("#theme-settings-offcanvas input[type=radio]").forEach(function(t) {
            t.checked = !1
        });
